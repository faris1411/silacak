...
CREATE TABLE `tanahs` (
  ...
  `batas_utara` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `batas_timur` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `batas_selatan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `batas_barat` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `luas` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `surat_tanah` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bentuk_surat` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `keterangan_legalitas` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `perangkat_daerah` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kode_barang` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `register` int(11) NOT NULL,
  `tahun_perolehan` char(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `harga` int(11) NOT NULL,
  `peruntukan_awal` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
